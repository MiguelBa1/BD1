                        ...
                        <div class="card-body">
                            <form action="update_nF.php" , class="form-group" method="post">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="codigo" id="codigo_edit" class="form-control" readonly value=<?= $_GET["codigo"]; ?>>
                                </div>
                                <div class="form-group">
                            ...
                            <form action="insert_nF.php" , class="form-group" method="post">
                                ...
                                <div id="casadosRow" class="form-group" style="display: none">
                                    <div>
                                        ...
                                        <input type="date" name="fecha_de_matrimonio" id="fecha_de_matrimonio" class="form-control">
                                    </div>
                                    <div>
                                        <label for="acta_de_matrimonio">Link acta de matrimonio</label>
                                        <input type="text" name="acta_de_matrimonio" id="acta_de_matrimonio" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
