...
<body>
            ...
            ?>
                <div class="col-6 px-2">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="update_nF.php" class="form-group submit-form" method="post">
                                <div class="form-group">
                                    <label for="codigo_edit">Codigo<span style="color: red;">*</span></label>
                                    <input type="number" name="codigo" id="codigo_edit" class="form-control" readonly value='<?= $_GET["codigo"]; ?>'>
                                </div>
                                <div class="form-group">
                                    <label for="numero_celular_edit">Número de celular<span style="color: red;">*</span></label>
                                    <input type="text" name="numero_celular" id="numero_celular_edit" class="form-control" value='<?= $_GET["numero_celular"]; ?>'>
                                </div>
                                <div class="form-group">
                                    <label for="dinero_edit">Dinero<span style="color: red;">*</span></label>
                                    <input type="number" name="dinero" id="dinero_edit" class="form-control" value='<?= $_GET["dinero"]; ?>'>
                                </div>
                                <div class="form-group">
                                    <label>Casados?<span style="color: red;">*</span></label><br>
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" class="custom-control-input" id="casadosSiEdit" name="casadosEdit" value="Si" required <?php if ($_GET["fecha_de_matrimonio"]) {
                                                                                                                                                        echo "checked";
                                                                                                                                                    } ?> />
                                        <label class="custom-control-label" for="casadosSiEdit">Sí</label>
                                    </div>
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" class="custom-control-input" id="casadosNoEdit" name="casadosEdit" value="No" required <?php if (!$_GET["fecha_de_matrimonio"]) {
                                                                                                                                                        echo "checked";
                                                                                                                                                    } ?> />
                                        <label class="custom-control-label" for="casadosNoEdit">No</label>
                                    </div>
                                </div>
                                <div id="casadosRowEdit" class="form-group" <?php if (!$_GET["fecha_de_matrimonio"]) {
                                                                            echo 'style="display: none"';
                                                                        } ?>>
                                    <div>
                                        <label for="fecha_de_matrimonio_edit">Fecha de matrimonio<span style="color: red;">*</span></label>
                                        <input type="date" name="fecha_de_matrimonio" value='<?= $_GET["fecha_de_matrimonio"]; ?>' id="fecha_de_matrimonio_edit" max="<?= (new DateTime('today'))->format('Y-m-d') ?>" class="form-control required">
                                    </div>
                                    <div>
                                        <label for="acta_de_matrimonio">Link acta de matrimonio<span style="color: red;">*</span></label>
                                        <input type="text" name="acta_de_matrimonio" value='<?= $_GET["acta_de_matrimonio"] ?>' id="acta_de_matrimonio_edit" class="form-control required">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <input type="submit" class="btn btn-primary save-btn" value="Guardar">
            ...
            ?>
                <div class="col-6 px-2">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="insert_nF.php" class="form-group submit-form" method="post">
                                <div>
                                ...
                                <div>
                                    ...
                                    <input type="number" name="dinero" id="dinero" class="form-control" min="0" max="99999999" required>
                                </div>
                                <div class="form-group">
                                    <label>Casados?<span style="color: red;">*</span></label><br>
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" class="custom-control-input" id="casadosSi" name="casados" value="Si" required />
                                        <label class="custom-control-label" for="casadosSi">Sí</label>
                                    </div>
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" class="custom-control-input" id="casadosNo" name="casados" value="No" required />
                                        <label class="custom-control-label" for="casadosNo">No</label>
                                    </div>
                                </div>
                                <div id="casadosRow" class="form-group" style="display: none">
                                    <div>
                                        <label for="fecha_de_matrimonio">Fecha de matrimonio<span style="color: red;">*</span></label>
                                        <input type="date" name="fecha_de_matrimonio" id="fecha_de_matrimonio" max="<?= (new DateTime("today"))->format('Y-m-d') ?>" class="form-control required">
                                    </div>
                                    <div>
                                        <label for="acta_de_matrimonio">Link acta de matrimonio<span style="color: red;">*</span></label>
                                        <input type="text" name="acta_de_matrimonio" id="acta_de_matrimonio" class="form-control required">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <tr>
                                    ...
                                    <td class="mx-0 pr-2">
                                        <form action="nucleo.php" method="GET">
                                            ...
                                            <input type="text" name="numero_celular" value='<?= $fila['numero_celular']; ?>' hidden>
                                            <input type="text" name="dinero" value='<?= $fila['dinero']; ?>' hidden>
                                            <input type="text" name="fecha_de_matrimonio" hidden value='<?= $fila['fecha_de_matrimonio']; ?>'>
                                            <input type="text" name="acta_de_matrimonio" hidden value='<?= $fila['acta_de_matrimonio']; ?>'>
    ...
    <script type="text/javascript">
        ...
        $('input[name="casadosEdit"]').change(function() {
            if ($('#casadosSiEdit').is(':checked')) {
                $('#casadosRowEdit').show(200);
            } else {
                $('#casadosRowEdit').hide(200);
            }
        });
    </script>
</body>
